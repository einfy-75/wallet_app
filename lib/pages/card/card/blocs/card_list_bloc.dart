...
class CardListBloc {
  final BehaviorSubject<List<CardResults>> _cardsCollection = BehaviorSubject<List<CardResults>>();
  List<CardResults> _cardResults = []; // Initialize _cardResults with an empty list
