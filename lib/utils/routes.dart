...
import 'package:wallet_app/pages/dashboard/instantpay/instapay.dart';
...
class RouteGenerator {
  ...
  static const String paymentSheetPage = "paymentSheetPage";
  ...
  static Route<dynamic> generateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case paymentSheetPage:
        return MaterialPageRoute(builder: (_) => PaymentBottomSheet());
