...
const Color secondaryColor = Color(0xFFFFA063);
const Color neutralColor = Color(0xFFEDEEF0);
const Color fillColor = Color(0xFFFFFFFF);
const Color secondaryButtonTextColor = Color(0xFFFFFFFF);
const Color arrowBackColor = Color(0xFF0C192C);
const Color navigationIconColor = Color(0xFFC2C5CA);
const Color yellowColor = Colors.green;
const Color secondaryFocusColor = Color(0xFFEF9426);
